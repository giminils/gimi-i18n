...
let templateDir = ['./text_strings/client', './text_strings/server', './text_strings/templates', './text_strings/gimi-web', './text_strings/share-image-generator', './text_strings/moonshine']
let DEFAULT_JSON = 'default.json'
let DEFAULT_FROM_FILE = 'sv.json'
...
/* Arvin 2018-04-23. Usage: npm run translate <langKey> */
...
let fromFileName = DEFAULT_FROM_FILE
