...
var fs = require('fs')
let templateDir = ['./text_strings/server', './text_strings/templates', './text_strings/gimi-web', './text_strings/client', './text_strings/bot', './text_strings/educationTimeComeAn']
...
let RunSara = (filePath): * => {
  ...
  let syncTextStrings = (file) => {
    ...
    if (!file.includes('sv.json') && !file.includes('en.json'))
